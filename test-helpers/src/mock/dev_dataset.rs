//! Development dataset for general testing and dev server
...
impl DevDataset {
    ...
    pub async fn create(app: &TestApp) -> Result<Self> {
        ...
        tracing::info!("Creating three-person community (Alice, Bob, Charlie)");
        ...
        tracing::info!("Creating auctions with realistic work schedules");
