    ...
    Scenario {
        ...
        state: EditorState {
            ...
            values: HashMap::from([
                ...
                ((dave, window), Decimal::new(150, 0)),
                ((dave, corner), Decimal::new(130, 0)),
                ((dave, middle), Decimal::new(100, 0)),
                ((dave, door), Decimal::new(60, 0)),
                ((eve, window), Decimal::new(130, 0)),
                ((eve, corner), Decimal::new(110, 0)),
                ((eve, middle), Decimal::new(90, 0)),
                ((eve, door), Decimal::new(70, 0)),
            ]),
            bid_increment: Decimal::new(10, 0),
        },
        currency: CurrencySettings {
